...
export interface ApiBadgeBadge extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    gradient: Schema.Attribute.Enumeration<
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    users: Schema.Attribute.Relation<'manyToMany', 'api::user.user'>;
  };
}
...
export interface ApiChallengeChallenge extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    skillCoins: Schema.Attribute.Integer & Schema.Attribute.Required;
...
export interface ApiResponseResponse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    isAccepted: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiUserUser extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    skillCoins: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    specialties: Schema.Attribute.Relation<
      'manyToMany',
      'api::specialty.specialty'
    >;
    totalContributions: Schema.Attribute.Integer;
    type: Schema.Attribute.Enumeration<
      ['Student', 'Lecturer', 'Industry Professional']
    >;
    university: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    weeklyGain: Schema.Attribute.Integer;
    weeklyRank: Schema.Attribute.Integer;
  };
}
